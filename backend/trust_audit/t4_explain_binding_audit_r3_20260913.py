# -*- coding: utf-8 -*-
"""T4 解释绑定审计（2026-09-13 R5 冻结后审计刷新（r3），独立复核算，只读运行产物）。
...
产出：同目录 t4_explain_binding_r3_20260913.json。
...
CODE = PKG / "code"
OUT = Path(__file__).resolve().parent / "t4_explain_binding_r3_20260913.json"
