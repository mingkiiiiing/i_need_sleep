...
from pipeline.sources.sentinel2_monthly import run_monthly_cube
...
if __name__ == "__main__":
    ...
    result = run_monthly_cube(date.fromisoformat(args.start), date.fromisoformat(args.end), **kwargs)
